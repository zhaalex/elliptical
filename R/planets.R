...
if (FALSE) {
  ...
  #
  planets <- data.frame(
    name = c('Mercury', 'Venus', 'Earth', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto', 'Io','Europa','Ganymede','Callisto'),
    distance = c(57.9, 108.2, 149.6, 227.9, 778.6, 1433.5, 2872.5, 4495.1, 5906.4, .422000,	.671000,1.070000,	1.883000),
    eccentricity = c(0.205, 0.007, 0.017, 0.094, 0.049, 0.057, 0.046, 0.011, 0.244, 0.0041,0.0094,0.0011,0.0074)
  )
  #
