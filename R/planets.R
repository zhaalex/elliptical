...
if (FALSE) {
  ...
  #
  planets <- data.frame(
    name = c('Mercury', 'Venus', 'Earth', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto', 'Eris', 'Haumea', 'Makemake', 'Sedna', 'Quaoar', 'Orcus'),
    distance = c(57.9, 108.2, 149.6, 227.9, 778.6, 1433.5, 2872.5, 4495.1, 5906.4, 10139.893, 6465.321, 6838.867, 75816.201, 6488.508, 5899.093),
    eccentricity = c(0.205, 0.007, 0.017, 0.094, 0.049, 0.057, 0.046, 0.011, 0.244, 0.44068, 0.19126, 0.15586, 0.85491, 0.034704, 0.2190)
  )
  #
